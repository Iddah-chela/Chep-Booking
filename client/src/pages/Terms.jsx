    ...
    <div className='max-w-4xl mx-auto px-4 py-16 sm:py-20'>
      ...
      <div className='prose prose-gray max-w-none space-y-6'>
        ...
        <section>
          ...
          <ul className='list-disc pl-6 text-gray-700 space-y-2'>
            <li>Unlocking owner contact details requires purchasing a browsing pass via M-Pesa (Ksh 50 for 1 day, Ksh 200 for 7 days). First 2 property views are free.</li>
