...
const ProfileModal = ({ onClose }) => {
    const { user, navigate, isOwner, isAdmin, isAgent, logout, dbImage, setDbImage, axios, getToken } = useAppContext()
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        {isAgent && (
                            ...
                            >
                                ...
                                <span className='text-gray-800 dark:text-gray-200 font-medium'>Agent Dashboard</span>
                            </button>
                        )}
