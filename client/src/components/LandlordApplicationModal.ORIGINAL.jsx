/**
 * ══════════════════════════════════════════════════════════════════
 * ORIGINAL LandlordApplicationModal (full application form version)
 * 
 * This is the backup of the original landlord application modal that
 * required ID documents, ownership proof, property details, etc.
 * and went through an admin approval flow.
 * 
 * To restore: rename this file to LandlordApplicationModal.jsx
 * (and remove/rename the current instant-signup version)
 * ══════════════════════════════════════════════════════════════════
 */
